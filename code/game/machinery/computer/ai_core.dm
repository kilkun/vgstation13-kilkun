...
/obj/structure/AIcore/deactivated
	...
	(Commented this out because it created exceptions and didn't seem important. If I broke shit just remove the if statement and everything should be cool)
		*/
				...
				switch(interaction)
					if("AICARD")
						...
						/*if(!C.AI && T.occupant && !T.active)
							...
							U << "\red <b>ERROR</b>: \black Unable to locate artificial intelligence."*/ /*Code from Nar-Sie's blessed Ninja code, so fuck it.*/
